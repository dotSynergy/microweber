                ...
                mw.filePickerDialog({
                    ...
                    urls.forEach((singleUrl) => {
                        if (typeof singleUrl === 'string' && singleUrl != '') {
                            let urlFileType = '';
                            let getFileExtension = singleUrl.split('.').pop();
                        ...
                        } else if (typeof singleUrl === 'object' && singleUrl.fileUrl) {
                            // Handle file object format
                            let fileUrl = singleUrl.fileUrl;
                            let urlFileType = singleUrl.fileType || '';
                            let getFileExtension = fileUrl.split('.').pop();
                            getFileExtension = getFileExtension.toLowerCase();
                            if (!urlFileType) {
                                if (getFileExtension == 'svg' || getFileExtension == 'webp' || getFileExtension == 'jpg' || getFileExtension == 'jpeg' || getFileExtension == 'png' || getFileExtension == 'gif') {
                                    urlFileType = 'image';
                            ...
                            state.push({
                                ...
                                'fileType': urlFileType,
                                'fileExtension': getFileExtension,
                                'fileUrlShort': fileUrl.split('/').pop()
                            });
                        }
                    });
                });
                ...
                <template x-for="fileItem in state">
                    ...
                    <div class="w-full" x-show="fileItem">
                        <div class="w-full relative flex flex-col items-center justify-center bg-black/80 rounded-md">
                            ...
                            <div class="flex items-center justify-center" style="width:100%;height:200px;padding:40px;"
                                 x-show="fileItem.fileType !== 'image'">
                                ...
                                <svg
                                    ...
                                    <path
                                        ...
                                        fill-rule="evenodd" clip-rule="evenodd" fill="#E34221"/>
