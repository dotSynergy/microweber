...
class MultilanguageCategoryApiTest extends MultilanguageTestBase
{
    ...
    public function testSave()
    {
        ...
        foreach ($activeLanguages as $language) {
            $this->assertEquals($findCategory->multilanguage_translations[$language['locale']]['url'], $saveMultilanguage['url'][$language['locale']]);
            $this->assertEquals($findCategory->multilanguage_translations[$language['locale']]['title'], $saveMultilanguage['title'][$language['locale']]);
            $this->assertEquals($findCategory->multilanguage_translations[$language['locale']]['description'], $saveMultilanguage['description'][$language['locale']]);
        }
