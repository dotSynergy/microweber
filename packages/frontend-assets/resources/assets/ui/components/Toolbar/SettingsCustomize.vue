...
<template>
    ...
    <div class="mw-live-edit-right-sidebar-wrapper me-2 " :class="'mw-live-edit-right-sidebar-template-' + template">
        ...
        <div v-on:click="handleQuickEdit()" :class="{'live-edit-right-sidebar-active': buttonIsActiveQuickEdit }"
            ...
            <svg focusable="false" aria-hidden="true" viewBox="0 0 24 24" width="22" fill="currentColor" style="margin-inline-start: 3px;"><path d="M9 4c-4.42 0-8 3.58-8 8s3.58 8 8 8 8-3.58 8-8-3.58-8-8-8m3 6.5h-2v5H8v-5H6V9h6zm8.25-6.75L23 5l-2.75 1.25L19 9l-1.25-2.75L15 5l2.75-1.25L19 1zm0 14L23 19l-2.75 1.25L19 23l-1.25-2.75L15 19l2.75-1.25L19 15z"></path></svg>
        </div>
