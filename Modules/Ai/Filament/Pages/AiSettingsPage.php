                ...
                Section::make('OpenAI Settings')
                    ...
                    ->schema([
                        ...
                        Select::make('options.ai.openai_model')
                            ...
                            ->helperText(fn() => new HtmlString('<small class="mb-2  "><a href="https://platform.openai.com/docs/models/gpt-4" target="_blank">Learn more</a> about the models.</small>')),
                        ...
                        TextInput::make('options.ai.openai_api_key')
                            ...
                            ->helperText(fn() => new HtmlString('<small class="mb-2  "><a href="https://platform.openai.com/signup" target="_blank">Sign up</a> for an OpenAI account to get your API key.</small>')),
                    ]),
                ...
                Section::make('Google Gemini Settings')
                    ...
                    ->schema([
                        ...
                        Select::make('options.ai.gemini_model')
                            ...
                            ->helperText(fn() => new HtmlString('<small class="mb-2  "><a href="https://ai.google.dev/models/gemini" target="_blank">Learn more</a> about the models.</small>')),
                        ...
                        TextInput::make('options.ai.gemini_api_key')
                            ...
                            ->helperText(fn() => new HtmlString('<small class="mb-2  "><a href="https://makersuite.google.com/app/apikey" target="_blank">Get your API key</a> from Google AI Studio.</small>')),
                    ]),
                ...
                Section::make('OpenRouter Settings')
                    ...
                    ->schema([
                        ...
                        Select::make('options.ai.openrouter_model')
                            ...
                            ->helperText(fn() => new HtmlString('<small class="mb-2  "><a href="https://openrouter.ai/" target="_blank">Learn more</a> about the models.</small>')),
                        ...
                        TextInput::make('options.ai.openrouter_api_key')
                            ...
                            ->helperText(fn() => new HtmlString('<small class="mb-2  "><a href="https://openrouter.ai/signup" target="_blank">Sign up</a> for an OpenRouter account.</small>')),
                    ]),
                ...
                Section::make('Ollama Settings')
                    ...
                    ->schema([
                        ...
                        Select::make('options.ai.ollama_model')
                            ...
                            ->helperText(fn() => new HtmlString('<small class="mb-2  "><a href="https://ollama.com/" target="_blank">Learn more</a> about the models.</small>')),
                        ...
                        TextInput::make('options.ai.ollama_api_url')
                            ...
                            ->helperText(fn() => new HtmlString('<small class="mb-2  ">Enter the URL for your local or remote Ollama instance.</small>')),
                    ]),
                ...
                Section::make('Anthropic/Claude Settings')
                    ...
                    ->schema([
                        ...
                        Select::make('options.ai.anthropic_model')
                            ...
                            ->helperText(fn() => new HtmlString('<small class="mb-2  "><a href="https://www.anthropic.com/claude" target="_blank">Learn more</a> about the models.</small>')),
                        TextInput::make('options.ai.anthropic_api_key')
                            ->live()
                            ->visible(fn(callable $get) => $get('options.ai.anthropic_enabled'))
                            ->label('Anthropic API Key')
                            ->placeholder('Enter your Anthropic API key')
                            ->helperText(fn() => new HtmlString('<small class="mb-2  ">Find your API key in your Anthropic account dashboard.</small>')),
                    ]),
                ...
                Section::make('Replicate Settings')
                    ...
                    ->schema([
                        ...
                        Select::make('options.ai.replicate_model')
                            ...
                            ->helperText(fn() => new HtmlString('<small class="mb-2  "><a href="https://replicate.com/collections/text-to-image" target="_blank">Learn more</a> about available models.</small>')),
                        ...
                        TextInput::make('options.ai.replicate_api_key')
                            ...
                            ->helperText(fn() => new HtmlString('<small class="mb-2  "><a href="https://replicate.com/account/api-tokens" target="_blank">Get your API token</a> from Replicate.</small>')),
