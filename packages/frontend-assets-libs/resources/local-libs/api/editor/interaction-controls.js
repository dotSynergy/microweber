...
MWEditor.interactionControls = {
    ...
    image: function (rootScope) {
        ...
        this.render = function () {
            ...
            var changeButton = mw.element({
                props: {
                    innerHTML:
                        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="icon"><path d="M19,19H5V5H19M19,3H5A2,2 0 0,0 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5A2,2 0 0,0 19,3M13.96,12.29L11.21,15.83L9.25,13.47L6.5,17H17.5L13.96,12.29Z" /></svg>',
            ...
            var deleteButton = mw.element({
                props: {
                    innerHTML:
                        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="icon"><title>delete-outline</title><path d="M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19M8,9H16V19H8V9M15.5,4L14.5,3H9.5L8.5,4H5V6H19V4H15.5Z" /></svg>',
                    className: "btn btn-icon",
                    dataset: {
            ...
            if (window.jQuery && jQuery.fn.resizable) {
                jQuery(el.get(0)).resizable({
                    ...
                    resize: function (event, ui) {
                        ...
                        el.css({
                            height: scope.$target.get(0).offsetHeight,
                            top: css.top,
                        });
                    },
                });
    ...
    tableManager: function (rootScope) {
        ...
        this.interact = function (data) {
            ...
            rootScope.document
                .querySelectorAll(".mw-editor-td-focus")
                .forEach((td) => td.classList.remove("mw-editor-td-focus"));
            if (td) {
                ...
                lscope.__tableManagerTimeout = setTimeout(() => {
                    ...
                    if (
                        parntRelative &&
                        rootScope.settings.editMode !== "liveedit"
                    ) {
        ...
        this.render = function () {
            ...
            var insertDD = new MWEditor.core.dropdown({
                data: [
                    {
                        label: "Row Above",
                        value: { action: "insertRow", type: "above" },
                    },
                    {
                        label: "Row Under",
                        value: { action: "insertRow", type: "under" },
                    },
                    {
                        label: "Column on the left",
                        value: { action: "insertColumn", type: "left" },
                    },
                    {
                        label: "Column on the right",
                        value: { action: "insertColumn", type: "right" },
                    },
                ],
        ...
        this.getActiveCell = function () {
            var node = rootScope.api.elementNode(
                rootScope.getSelection().focusNode
            );
