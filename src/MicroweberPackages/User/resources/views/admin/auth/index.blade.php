    ...
    <div class="auth-card">
        ...
        <div class="logged-in-section">
            <div class="user-avatar">
                @if($currentUser->thumbnail)
                    <img src="{{ $currentUser->thumbnail }}" alt="{{ $currentUser->first_name ?? $currentUser->username }}" style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">
                @else
        ...
        <div class="auth-tab-content active" id="login">
            ...
            <div class="social-login-section">
                @if($enableFacebook)
                <a href="{{ api_url('social_login?provider=facebook') }}" class="btn btn-social btn-facebook">
                ...
                @if($enableGoogle)
                <a href="{{ api_url('social_login?provider=google') }}" class="btn btn-social btn-google">
                ...
                @if($enableGithub)
                <a href="{{ api_url('social_login?provider=github') }}" class="btn btn-social btn-github">
                ...
                @if($enableLinkedin)
                <a href="{{ api_url('social_login?provider=linkedin') }}" class="btn btn-social btn-linkedin">
                ...
                @if($enableTwitter)
                <a href="{{ api_url('social_login?provider=twitter') }}" class="btn btn-social btn-twitter">
            ...
            <form id="loginForm" method="POST" action="{{ route('api.user.login') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" autocomplete="current-password" name="password" required>
                </div>
        ...
        <div class="auth-tab-content" id="register">
            ...
            <form id="registerForm" method="POST" action="{{ route('api.user.register') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" autocomplete="current-password" name="password_confirmation" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="checkbox-wrapper">
                        ...
                        <label for="agree_terms" style="margin: 0; font-weight: normal;">
                            I agree to the <a href="{{ get_option('terms_page_url', 'users') }}" target="_blank">Terms and Conditions</a>
                        </label>
                    </div>
                </div>
                @endif
