...
class MultilanguageProductTest extends MultilanguageTestBase
{
    ...
    public function testSaveProductFromApiController()
    {
        ...
        $this->assertEquals($getProduct->multilanguage_translations['bg_BG']['title'], $apiProductStore['multilanguage']['title']['bg_BG']);
        $this->assertEquals($getProduct->multilanguage_translations['bg_BG']['content'], $apiProductStore['multilanguage']['content']['bg_BG']);

        $this->assertEquals($getProduct->multilanguage_translations['ar_SA']['title'], $apiProductStore['multilanguage']['title']['ar_SA']);
        $this->assertEquals($getProduct->multilanguage_translations['ar_SA']['content'], $apiProductStore['multilanguage']['content']['ar_SA']);

        $this->assertEquals($getProduct->multilanguage_translations['ru_RU']['title'], $apiProductStore['multilanguage']['title']['ru_RU']);
        $this->assertEquals($getProduct->multilanguage_translations['ru_RU']['content'], $apiProductStore['multilanguage']['content']['ru_RU']);
