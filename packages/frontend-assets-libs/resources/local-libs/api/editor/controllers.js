MWEditor.controllers = {
    alignLeft: function (scope, api, rootScope) {
        ...
        this.checkSelection = function (opt) {
            rootScope.disabled(
                opt.controller.element,
                !opt.api.isSelectionEditable() ||
                    !opt.api.targetSupportsFormatting(
                        opt.api.elementNode(opt.api.getSelection().focusNode)
                    )
            );

            rootScope.controllerActive(
                el.get(0),
                "left" === opt.css.alignNormalize()
            );
        };
    ...
    alignJustify: function (scope, api, rootScope) {
        ...
        this.checkSelection = function (opt) {
            ...
            rootScope.controllerActive(
                el.get(0),
                "justify" === opt.css.alignNormalize()
            );
        };
        this.element = this.render();
    },
    align: function (scope, api, rootScope) {
        ...
        this.root.$node.addClass(
            "mw-editor-state-component mw-editor-state-component-align"
        );
        this.buttons = [];
        ...
        var arr = [
            {
                align: "left",
                icon: '<svg  viewBox="0 0 24 24"><path fill="currentColor" d="M3,3H21V5H3V3M3,7H15V9H3V7M3,11H21V13H3V11M3,15H15V17H3V15M3,19H21V21H3V19Z" /></svg>',
                action: "left",
            },
            {
                align: "center",
    ...
    backToElementSettings: function (scope, api, rootScope) {
        ...
        this.render = function () {
            var iconSVG =
                '<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="m336-280-56-56 144-144-144-143 56-56 144 144 143-144 56 56-144 143 144 144-56 56-143-144-144 144Z"/></svg>';
            var scope = this;
            var el = MWEditor.core.button({
                props: {
            ...
            el.on("click", (e) => {
                ...
                if (isInLiveEdit && this.target) {
                    mw.top()
                        .win.mw.app.liveEdit.handles.get("element")
                        .set(this.target);
                    setTimeout(() => {
                        const target = mw
                            .top()
                        ...
                        mw.app.canvas
                            ...
                            .forEach((node) => (node.contentEditable = false));
        ...
        this.checkSelection = function (opt, ee, tt) {
            ...
            if (focusNode) {
                ...
                if (elementNode && mw.top().app.liveEdit) {
                    elementNode = mw.tools.firstParentOrCurrentWithAnyOfClasses(
                        elementNode,
                        ["edit", "element"]
                    );
                    allowed = !!elementNode;
    ...
    plus: function (scope, api, rootScope) {
        ...
        this.render = function () {
            var plusIconSVG =
                '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M445.935-195.935v-250h-250v-68.13h250v-250h68.13v250h250v68.13h-250v250h-68.13Z"/></svg>';
            var scope = this;
            var el = MWEditor.core.button({
                props: {
            ...
            if (focusNode) {
                ...
                if (elementNode && mw.top().app.liveEdit) {
                    ...
                    allowed =
                        ...
                        mw
                            .top()
                            .app.liveEdit.elementHandleContent.settingsTarget.canDropInTarget(
                                elementNode
                            );
                }
            }
        ...
        this.render = function () {
            ...
            el.on("click", function (e) {
                ...
                var buttonsTone = [
                    {
                        text: "Friendly",
                        instruction: "Make the text more friendly",
                    },
                    {
                        text: "Casual",
                        instruction: "Make the text sound casual",
                    },
                    {
                        text: "Natural",
                        instruction: "Make the text sound natural",
                    },
                    {
                        text: "Friendly",
                        instruction: "Make the text sound friendly",
                    },
                    {
                        text: "Gentle",
                        instruction: "Make the text sound gentle",
                    },
                ];
                ...
                <div class="ai-text-generator-container">
                    ...
                    <div class="mt-2" id="ai-text-generator-options">
                        ...
                        <nav class="d-flex" role="tablist">
                            <a class="btn btn-link justify-content-center mw-admin-action-links mw-adm-liveedit-tabs" role="tab" tabindex="-1">${mw.lang(
                                "Rewrite"
                            )}</a>
                            <a class="btn btn-link justify-content-center mw-admin-action-links mw-adm-liveedit-tabs" role="tab" tabindex="-1">${mw.lang(
                                "Tone"
                ...
                setTimeout(function () {
                    document
                        .querySelectorAll(
                            "#ai-text-generator-options button[data-instruction]"
                        )
                        .forEach(function (node) {
                            node.addEventListener("click", function () {
                                document.getElementById(
                                    "ai-text-generator-options"
                                ).style.display = "none";
                                document.getElementById(
                                    "ai-text-generator-topic"
                                ).value = this.dataset.instruction;
                                $("#ai-text-generator-submit").click();
                            });
                        });

                    mw.tabs({
                        nav: aiTextAutocompleteDialog.dialogContainer.querySelectorAll(
                            ".mw-adm-liveedit-tabs"
                        ),
                        tabs: aiTextAutocompleteDialog.dialogContainer.querySelectorAll(
                            ".mw-aiwriter-tab"
                        ),
                    });
                    document.getElementById("ai-text-generator-topic").focus();
                    document
                        .getElementById("ai-text-generator-topic")
    ...
    bold: function (scope, api, rootScope) {
            ...
            el.on("click", async function (e) {
                ...
                if (sel.getRangeAt(0).collapsed) {
                    ...
                    api.action(actionTarget.parentNode, function () {
                        var isBold =
                            Number(
                                rootScope.actionWindow.getComputedStyle(
                                    actionTarget
                                ).fontWeight
                            ) > 400;
                        ...
                        if (rootScope.settings.editMode === "liveedit") {
                            ...
                            const edit =
                                mw.tools.firstParentOrCurrentWithClass(
                                    node,
                                    "edit"
                                ) ||
                                (rootScope.$editArea
                                    ? rootScope.$editArea[0]
                                    : false);
                            ...
                            if (rootScope.editArea === actionTarget) {
                                ...
                                var getFocusedNeighbours =
                                    api.getFocusedNeighbours(sel.focusNode);
                                sel.focusNode.after(newBlock);
                                getFocusedNeighbours.forEach((el) =>
                                    newBlock.appendChild(el)
                                );
                                newBlock.style.fontWeight = weight;
                                newBlock
                                    .querySelectorAll("*")
                                    .forEach(
                                        (n) => (n.style.fontWeight = weight)
                                    );
        ...
        this.checkSelection = function (opt, ee, tt) {
            ...
            rootScope.disabled(
                opt.controller.element.get(0),
                opt.isPlainText || !opt.api.isSelectionEditable(opt.selection)
            );
        };
        this.element = this.render();
    },
    strikeThrough: function (scope, api, rootScope) {
        this.render = function () {
            ...
            var el = MWEditor.core.button({
                props: {
                    innerHTML:
                        '<svg viewBox="0 0 24 24" style="transform: scale(0.93)"><path fill="currentColor" d="M23,12V14H18.61C19.61,16.14 19.56,22 12.38,22C4.05,22.05 4.37,15.5 4.37,15.5L8.34,15.55C8.37,18.92 11.5,18.92 12.12,18.88C12.76,18.83 15.15,18.84 15.34,16.5C15.42,15.41 14.32,14.58 13.12,14H1V12H23M19.41,7.89L15.43,7.86C15.43,7.86 15.6,5.09 12.15,5.08C8.7,5.06 9,7.28 9,7.56C9.04,7.84 9.34,9.22 12,9.88H5.71C5.71,9.88 2.22,3.15 10.74,2C19.45,0.8 19.43,7.91 19.41,7.89Z" /></svg>',
            ...
            el.on("click", function (e) {
                ...
                if (sel.getRangeAt(0).collapsed) {
                    ...
                    var actionTarget = node; // mw.tools.firstBlockLikeLevel(node);
                    api.action(actionTarget.parentNode, function () {
                        var isStrike = rootScope.actionWindow
                            .getComputedStyle(actionTarget)
                        ...
                        if (rootScope.settings.editMode === "liveedit") {
                            ...
                            if (rootScope.editArea === actionTarget) {
                                ...
                                newBlock
                                    .querySelectorAll("*")
                                    .forEach(
                                        (n) => (n.style.textDecoration = "")
                                    );

                                rootScope.api.setCursorAtStart(newBlock);
                            } else {
                                actionTarget.style.textDecoration =
                                    textDecoration;
                                actionTarget
                                    .querySelectorAll("*")
                                    .forEach(
    ...
    italic: function (scope, api, rootScope) {
        ...
        this.checkSelection = function (opt) {
            rootScope.disabled(
                opt.controller.element.get(0),
                !opt.api.isSelectionEditable(opt.selection)
            );
            ...
            rootScope.disabled(
                opt.controller.element.get(0),
                !opt.rangeInEditor || opt.isPlainText
            );
        };
        this.element = this.render();
    },
    ...
    image: function (scope, api, rootScope) {
        this.render = function () {
            ...
            el.on("click", function (e) {
                ...
                var picker = new mw.filePicker({
                    ...
                    okLabel: (val) => {
                        const number =
                            val && val.length !== undefined ? val.length : 0;
                        return number <= 1
                            ? mw.lang("Insert image")
                            : mw.lang(`Insert images`);
                    },
                    cancel: function () {
                        dialog.remove();
                    },
                    onResult: function (res) {
                        ...
                        if (
                            rootScope.activeNode &&
                            rootScope.activeNode.nodeName === "IMG"
                        ) {
        ...
        this.checkSelection = function (opt) {
            ...
            let isDisabled =
                opt.isPlainText ||
                !opt.api.isSelectionEditable(opt.selection) ||
                (!opt.api.targetSupportsFormatting(node) &&
                    rootScope.settings.mode !== "div");
    ...
    link: function (scope, api, rootScope) {
        ...
        this.checkSelection = function (opt) {
            ...
            rootScope.controllerActive(
                opt.controller.element.get(0),
                !!mw.tools.firstParentOrCurrentWithTag(
                    api.elementNode(api.getSelection().focusNode),
                    "a"
                )
            );
        };
    ...
    fontSize: function (scope, api, rootScope, bar) {
        this.checkSelection = function (opt) {
            ...
            opt.controller.element
                .find(".mw-editor-dropdown-option.active")
                .removeClass("active");
            opt.controller.element
                .find(".mw-editor-dropdown-option.active")
                .removeClass("active");
        ...
        this.render = function () {
            ...
            scope.on("smallEditorSkinChanged", (skin) => {
                ...
                if (!dropdown.root.find("iframe").get(0).contentWindow.document)
                    return;
                if (
                    !dropdown.root
                        .find("iframe")
                        .get(0)
                        .contentWindow.document.querySelector("input")
                )
                    return;

                const field = dropdown.root
                    .find("iframe")
                    .get(0)
                    .contentWindow.document.querySelector("input");
                if (field) {
    ...
    lineHeight: function (scope, api, rootScope) {
        this.checkSelection = function (opt) {
            ...
            var val =
                Math.round(
                    (parseFloat(font.height) / parseFloat(font.size)) * 10
                ) / 10;
    ...
    format: function (scope, api, rootScope) {
        ...
        this._availableTags = [
            {
                label: '<mw-editor-option class="mw-editor-option-dropdown-h1">Heading 1</mw-editor-option>',
                value: "h1",
                title: "Heading 1",
            },
            {
                label: '<mw-editor-option class="mw-editor-option-dropdown-h2">Heading 2</mw-editor-option>',
                value: "h2",
                title: "Heading 2",
            },
            {
                label: '<mw-editor-option class="mw-editor-option-dropdown-h3">Heading 3</mw-editor-option>',
                value: "h3",
                title: "Heading 3",
            },
            {
                label: '<mw-editor-option class="mw-editor-option-dropdown-h4">Heading 4</mw-editor-option>',
                value: "h4",
                title: "Heading 4",
            },
            {
                label: '<mw-editor-option class="mw-editor-option-dropdown-h5">Heading 5</mw-editor-option>',
                value: "h5",
                title: "Heading 5",
            },
            {
                label: '<mw-editor-option class="mw-editor-option-dropdown-h6">Heading 6</mw-editor-option>',
                value: "h6",
                title: "Heading 6",
            },
        ...
        this.checkSelection = function (opt) {
            ...
            var parentEl = mw.tools.firstParentOrCurrentWithTag(
                el,
                this.availableTags()
            );
            ...
            opt.controller.element
                .get(0)
                .querySelector(
                    ".mw-editor-select-display-value-content"
                ).textContent = parentEl
                ? this.getTagDisplayName(parentEl.nodeName)
                : "";
            const element = opt.api.elementNode(
                opt.api.getSelection().focusNode
            );

            const unsuportedElements = [
                "table",
                "tr",
                "td",
                "th",
            ...
            const elementSupports =
                unsuportedElements.indexOf(element.nodeName.toLowerCase()) ===
                -1;
    ...
    fontSelector: function (scope, api, rootScope) {
        ...
        this.render = function () {
            ...
            if (mw.top().app && mw.top().app.fontManager) {
                mw.top().app.fontManager.subscribeToSelectedFont(function (
                    selectedFontEvent
                ) {
                    try {
                        var sel = api.getSelection();
                        ...
                        var focusNode = sel.focusNode;
                        if (
                            selectedFontEvent.applyToSelectedElement ==
                            focusNode
                        ) {
    ...
    undoRedo: function (scope, api, rootScope) {
        this.render = function () {
            ...
            $(rootScope.state)
                .on("stateRecord", function (e, data) {
                ...
                .on("stateUndo stateRedo", function (e, data) {
                    ...
                    if (
                        scope.actionWindow.document.body.contains(
                            data.active.target
                        )
                    ) {
                        ...
                        if (data.active.target.id) {
                            mw.$(
                                scope.actionWindow.document.getElementById(
                                    data.active.target.id
                                )
                            ).html(data.active.value);
                        }
                    }
                    if (data.active.prev) {
    ...
    ul: function (scope, api, rootScope) {
        this.render = function () {
            ...
            el.on("click", function (e) {
                var isSafeMode = mw.tools.parentsOrCurrentOrderMatchOrOnlyFirst(
                    scope.api.elementNode(scope.api.getSelection().focusNode),
                    ["safe-mode", "regular-mode"]
                );
                ...
                var sel = api.getSelection();
                var node = api.elementNode(sel.focusNode);
                const parentLi = mw.tools.firstParentOrCurrentWithTag(
                    node,
                    "li"
                );
                ...
                var edit = mw.tools.firstParentOrCurrentWithClass(
                    parentList || node,
                    "edit"
                );
                ...
                var isInList = mw.tools.firstParentOrCurrentWithTag(node, [
                    "ul",
                    "ol",
                ]);
                if (isInList) {
                ...
                setTimeout(function () {
                    if (edit) {
                        ...
                        var allp = edit.querySelectorAll(
                        ...
                        allp.forEach((node) => {
                            var pp = mw.tools.firstParentOrCurrentWithTag(
                                node,
                                ["h1", "h2", "h3", "h4", "h5", "h6", "p"]
                            );
    ...
    removeFormat: function (scope, api, rootScope) {
        this.render = function () {
            ...
            el.on("click", function (e) {
                ...
                const commonAncestorContainer = api.elementNode(
    ...
    unlink: function (scope, api, rootScope) {
        ...
        this.checkSelection = function (opt) {
            ...
            rootScope.disabled(
                ...
                opt.isPlainText ||
                    !opt.api.isSelectionEditable(opt.selection) ||
                    !isLink /*|| !opt.api.targetSupportsFormatting(opt.api.elementNode(opt.api.getSelection().focusNode))*/
            );
        };
        this.element = this.render();
    },
    ...
    textColor: function (scope, api, rootScope) {
        ...
        this.checkSelection = function (opt) {
            ...
            var colorIndicator = opt.controller.element
                .get(0)
                .querySelector(".mw-editor-color-picker-color-indicator");

            if (!colorIndicator) {
                colorIndicator = opt.controller.element
                    .get(0)
                    .ownerDocument.createElement("span");
                colorIndicator.className =
                    "mw-editor-color-picker-color-indicator";
            ...
            rootScope.disabled(
                opt.controller.element.get(0),
                !opt.rangeInEditor || opt.controller.element.get(0),
                opt.isPlainText ||
                    !opt.api.isSelectionEditable(opt.selection) ||
                    !opt.api.targetSupportsFormatting(
                        opt.api.elementNode(opt.api.getSelection().focusNode)
        ...
        this.render = function () {
            ...
            el.on("click", function (e) {
                ...
                var ok = MWEditor.core.element({
                    ...
                    props: {
                        className:
                            "mw-admin-action-links mw-adm-liveedit-tabs mw-liveedit-button-animation-component",
