    ...
    <div class="col-md-6">
        ...
        <div class="row justify-content-center">
            ...
            <div class="d-flex justify-content-end">
                ...
                <a href="javascript:;" onclick="mw.cart.add_and_show_modal('{{$product->id}}','{{$product->price}}', '{{$product->title}}')" class="btn btn-outline-primary"><i class="mdi mdi-cart"></i> <?php _lang("Add to cart", 'templates/shopmag') ?></a>
                <?php else: ?>
